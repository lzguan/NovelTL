...
prompt = "I will give you a list of words separated by spaces, along with a chapter of a fantasy novel. Please translate these words as they appear in the novel. Only output the English names of the terms, separated by newlines. If the term does not appear in the text, output ERROR instead.\\n"

with open('glossary.txt', 'r') as f, open('glossary_bin.jsonl', 'w') as g:
    for line in f:
